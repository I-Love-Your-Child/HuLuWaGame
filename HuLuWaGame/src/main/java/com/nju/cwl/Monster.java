...
class Frog extends Role
{
	...
	public Frog(int i)
	{
		setCharacters("Frog" + (i + 1), 1000, 100, 1000, 100, 10, new Node(9 * Formation.M, 0), "file:src/main/resources/images/frog.png",
				"file:src/main/resources/images/frog_info.png", "file:src/main/resources/images/frog.png", "file:src/main/resources/images/Frog.gif", "file:src/main/resources/attack/bossF1.gif",
